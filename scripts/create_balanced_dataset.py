...
def create_dataset(model_type, run_id, snapshot_iteration, output_path, partition='valid', batch_size=8, limit_tokens = 1000, no_gpu=False):
    ...
    output_data_manager = CTBufferedDataManager(output_path, config['data_setup']['language'], partition)
